                    ...
                    if (enemigo.mokepon !== undefined)
                    {
                        ...
                        case "Hipodoge":
                            ...
                            case "Ratigueya":
                                ...
                                break
                            case "Langostelvis":
                                mokeponEnmigo = new Mokepon('Langostelvis', './assets/mokepons_mokepon_langostelvis_attack.png', '5', './assets/langostelvis.png', enemigo.id)
                                    break;
                                case "Pydos":
                                    mokeponEnmigo = new Mokepon('Pydos','./assets/mokepons_mokepon_pydos_attack.png', '5', './assets/pydos.png', enemigo.id)
                                    break;
                                case "Tucansin":
                                    mokeponEnmigo = new Mokepon('Tucansin','./assets/mokepons_mokepon_tucapalma_attack.png','5', './assets/tucansin.png', enemigo.id)
                                    break;
                                default:
...
function obtenerObjetoMascota() {
    ...
    return null;  // Devuelve null si no se encuentra ningún mokepon.
}
